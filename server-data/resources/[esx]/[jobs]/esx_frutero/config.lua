...
Config.Zones = {
    ...
    VehicleSpawner = {
        Pos = {x = 407.87, y = 6498.17, z = 26.80},
        Size = {x = 1.5, y = 1.5, z = 0.2},
        Color = {r = 0, g = 255, b = 0},
        Text = 'Pulsa ~r~[E]~s~ para sacar un vehículo',
        Type = 1,
        Rotate = false
    },
    ...
    VehicleDeleter = {
        ...
        Color = {r = 255, g = 0, b = 0},
        Text = 'Pulsa ~r~[E]~s~ para devolver el vehículo',
        Type = 1,
        Rotate = false
    },

    Cloakroom = {
        Pos = {x = 405.53994750977, y = 6526.32421875, z = 26.80},
        Size = {x = 1.5, y = 1.5, z = 0.2},
        Color = {r = 0, g = 255, b = 0},
        Text = 'Pulsa ~r~[E]~s~ para abrir el vestuario',
        Type = 1,
        Rotate = false
    },
    ...
    Job1 = {
        ...
        Text = 'Pulsa ~r~[E]~s~ para empezar a recoger fruta',
        Type = 23,
        Rotate = false
    },
    ...
    Job1b = {
        ...
        Size = {x = 20.0, y = .0, z = .0},
        Color = {r = 211, g = 211, b = 211},
        Text = 'Pulsa ~r~[E]~s~ ~s~para empezar a recoger fruta',
        Type = 23,
        Rotate = false
    },
    ...
    Job3a = {
        ...
        Text = 'Pulsa ~r~[E]~s~ para sacar sacar la fruta del vehículo',
        Type = 1,
        Rotate = false
    },
}
