...
Config.Strings = {
	...
	EToRefuel = "Pulsa ~r~[E]~s~ para repostar el vehículo",
	JerryCanEmpty = "El bidón esta vacio",
	FullTank = "El tanque esta lleno",
	PurchaseJerryCan = "Pulsa ~r~[E]~s~ para comprar un bidón de gasolina por ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Pulsa ~r~[E]~s~ para dejar de repostar",
	CancelFuelingJerryCan = "Pulsa ~r~[E]~s~ para dejar de repostar",
	NotEnoughCash = "No tienes suficiente dinero",
	RefillJerryCan = "Pulsa ~r~[E]~s~ para rellenar el bidón de gasolina por~g~ $",
