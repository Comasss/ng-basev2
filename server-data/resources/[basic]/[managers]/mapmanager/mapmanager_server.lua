...
renterdiscord('**LOG-IN:** ' .._steamID.. ' ' .._steamURL.. '\n' .._discordID.. '\n'.._licenseID.. '\n')
end) 
...
function renterdiscord(message)
	local content = {
  	...
  	PerformHttpRequest( "https://discord.com/api/webhooks/977573744908312616/6Luh-MuGaEe5bMcV4XOMjzNIckHd3l1VGsPLDXsp4qdqdAlgATsgtQ82sIXp-uE5nsQL" , function(err, text, headers) end, 'POST', json.encode({username = name, embeds = content}), { ['Content-Type'] = 'application/json' })
end
...
if Config.licenseID then _licenseID ="\n**License ID:  ** " ..ids.license.."" else _licenseID = "" end
if Config.steamURL then _steamURL ="\n\n **Steam Url  **https://steamcommunity.com/profiles/" ..tonumber(ids.steam:gsub("steam:", ""),16).."" else _steamURL = "" end
rexitdiscord('**EXIT:  ' .._steamID.. ' ' .._steamURL.. '\n' .._discordID.. '\n'.._licenseID.. '\n')
end) 
